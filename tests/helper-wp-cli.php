...
if ( ! class_exists( 'WP_CLI' ) ) {
	...
	class WP_CLI {
		 ...
		 * the command carried on operating on a share it had just said did not
		 ...
		 * ahead. A test that wants the revoke to happen passes --yes, exactly as
		 * a script would.
		 *
...
require_once dirname( __DIR__ ) . '/includes/class-wp-draftsforfriends-command.php';
